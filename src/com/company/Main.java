...
public class Main {
    ...
    public static void main(String[] args) {
		...
		System.out.println("กด 1 เพื่อฝากเงิน \nกด 2 เพื่อถอนเงิน \nกด 3 เพื่อดูยอดเงินคงเหลือในบัญชี ");
		System.out.println("-----------------------------------------------");
		System.out.println("เลือกรายการทำการของท่าน : ");
		String sv = sc.nextLine();
		if (sv.equals("1")) {
			Deposit deposit = new Deposit();
			System.out.println("กด 1 เงินฝากในบัญชีแระจำ \nกด 2 เงินฝากบัญชีออมทรัพย์ ");
			...
			if (dp.equals("1")) {
				...
				System.out.println("กด 1 เงินถอนประจำบัญชี \nกด 2 เงินถอนบัญชีออมทรัพย์");
				System.out.print("เลือกบริการของท่าน :");
				...
				System.out.println("กด 1 เพื่อตรวจสอบบัญชีประจำ \nกด 2 เพื่อตรวจยอดเงินเงินฝากบัญชีออมทรัพย์ ");
				System.out.print("เลือกบริการของท่าน :");
